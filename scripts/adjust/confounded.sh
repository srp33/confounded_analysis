...
confounded /data/simulated_expression/unadjusted.csv -o /data/simulated_expression/confounded.csv -b Batch -f /outputs/metrics/simulated_confounded_log.csv -c 50 -s "sigmoid" -w 1.0 -g 0.0001 -m 256 -i 10000 -a 2
