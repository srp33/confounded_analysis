...
# plot_adjusters_relative_only.R
# Generate only the relative performance plot
...
source("scripts/generate_relative_plot.R")

parser <- ArgumentParser(description = "Create relative performance plot")
...
# Generate plot
generate_relative_plot(mxe_data, unique_adjusters[1], adjuster_labels[1], 
                      args$output, args$width, args$height, args$dpi)
