...
process COMBINE {
    ...
    python /scripts/evaluations/classify_er_all_datasets/combine_all.py \
        --input-dir $gold_dir \
...
process ADJUST {
    ...
    script: 
    """
    # Extract subset index from filename
    basename = \$(basename $subset_csv)
    subset_idx=\$echo \$basename | sed =E 's/subset_([0-9]+)studies\\.csv/\\1/'
