...
data_dir <- "/scripts/evaluations/combat_seq_preston/real_data_application"  # path to the signature data (.rds)
source("/scripts/evaluations/combat_seq_preston/real_data_application/gfrn_helpers.R")  # path to gfrn_helpers.R
#source("/scripts/evaluations/combat_seq_preston/ComBat_seq.R"); source("/scripts/evaluations/combat_seq_preston/helper_seq.R")   
...
group_sub <- factor(as.character(group_sub), levels = c("gfp", "her2", "egfr", "kraswt"))
